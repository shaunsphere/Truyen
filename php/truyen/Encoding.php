...
class Encoding {
  ...
  static function UTF8FixWin1252Chars($text){
    ...
    // (ignoring Windows-1252 chars from 80 to 9F) use this function to fix it. Windows-1258
  ...
  {
    // $o = utf8_decode(
    //   str_replace(array_keys(self::$utf8ToWin1252), array_values(self::$utf8ToWin1252), self::toUTF8($text)) ///IGNORE   TRANSLIT
    // );
    $o = iconv("UTF-8", "Windows-1252//TRANSLIT", $text);
    return $o;
  }

  static function ordutf8($string, &$offset) 
  {
